                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="sex" class="form-select" required>
                                    <option value="L" {{ $apoteker->person->sex == 'L' ? 'selected' : '' }}>Laki-laki
                                    </option>
                                    <option value="P" {{ $apoteker->person->sex == 'P' ? 'selected' : '' }}>Perempuan
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select" required>
                                    <option value="aktif" {{ $apoteker->status == 'aktif' ? 'selected' : '' }}>Aktif
                                    </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="employment_status" class="form-select" required>
                                    <option value="Tetap"
                                        {{ $apoteker->employment_status == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                                    <option value="Kontrak"
                                        {{ $apoteker->employment_status == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                                    <option value="Magang"
                                        {{ $apoteker->employment_status == 'Magang' ? 'selected' : '' }}>Magang</option>
                                </select>
                            </div>
