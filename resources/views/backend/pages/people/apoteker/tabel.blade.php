                ...
                <div class="table-responsive">
                    <table class="table align-middle table-hover modern-table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $i + 1 }}</td>
                                {{-- 🖼️ Tampilkan gambar profil --}}
                                <td>
                                    <img src="{{ $apoteker->profile_image? asset('storage/' . $apoteker->profile_image): asset('assets/img/default-avatar.png') }}"
                                        alt="Foto Profil" class="rounded-3 shadow-sm" style="width: 45px; height: 60px; object-fit: cover; border: 1px solid #ddd;">
                                </td>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <p class="fw-semibold">
                                                                {{ $apoteker->person->dob
                                        ? \Carbon\Carbon::parse($apoteker->person->dob)->translatedFormat('d F Y')
                                        : '-' }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            ...
                                                            <p class="fw-semibold">{{ $apoteker->person->pob ?? '-' }}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            ...
                                                            <p class="fw-semibold">{{ $apoteker->license_number ?? '-' }}</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="mb-1 text-muted small">Tanggal Mulai Kerja</p>
                                                            <p class="fw-semibold">
                                                                {{ $apoteker->start_date
                                        ? \Carbon\Carbon::parse($apoteker->start_date)->translatedFormat('d F Y')
                                        : '-' }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            <p class="mb-1 text-muted small">Pendidikan Terakhir</p>
                                                            <p class="fw-semibold">{{ $apoteker->last_education ?? '-' }}</p>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            ...
                                                            <p class="fw-semibold">{{ $apoteker->shift ?? '-' }}</p>
                                                        </div>
                                                        <div class="col-6">
                            ...
                            <div class="modal fade" id="modalEditApoteker{{ $apoteker->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content rounded-4 border-0 shadow">
                                        ...
                                        {{-- Form --}}
                                        <form action="{{ route('apoteker.update', $apoteker->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="sex" class="form-select">
                                                            <option value="L" {{ $apoteker->person->sex == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                                            <option value="P" {{ $apoteker->person->sex == 'P' ? 'selected' : '' }}>Perempuan</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="status" class="form-select">
                                                            ...
                                                            <option value="nonaktif" {{ $apoteker->status == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="employment_status" class="form-select">
                                                            <option value="Tetap" {{ $apoteker->employment_status == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                                                            <option value="Kontrak" {{ $apoteker->employment_status == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                                                            <option value="Magang" {{ $apoteker->employment_status == 'Magang' ? 'selected' : '' }}>Magang</option>
                                                        </select>
                                                    </div>
