...
<!-- Mirrored from zuramai.github.io/mazer/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 17:43:09 GMT -->
<!-- Added by HTTrack -->
...
<body>
        ...
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-wrapper">
                    <!-- Sidebar Header -->
                    <div class="sidebar-header position-relative text-center py-4">
                        <!-- Logo -->
                        <div class="logo mb-3">
                            <a href="index.html">
    ...
    <script src="{{ asset('assets/static/js/pages/dashboard.js') }}" defer></script>
    ...
    <script>
        document.querySelectorAll('.sidebar-item.has-sub > .sidebar-link').forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                parent.classList.toggle('activ'); // toggle saja

                // Hapus bagian ini:
                // document.querySelectorAll('.sidebar-item.has-sub').forEach(i => {
                //     if (i !== parent) i.classList.remove('activ');
                // });
            });
        });
    </script>
    ...
    <!-- Script untuk membuat card klik bisa aktif sebagai tab -->
    <script>
